...
begin
  ...
  try
    ...
    RetornarEstoque(AVendaID, cds.FieldByName('produtoId').AsString, aeeAlterar);
...
procedure TControllerVenda.RetornarEstoque(AVendaId: Integer; sCodigo:String; Acao:TAcaoExcluirEstoque);
var
...
begin
  ...
  VendaDS.ParamByName('vendaId').AsInteger := AVendaId;
  ...
  begin
    ...
    FModelEstoque.produtoQuantidade := VendaDS.FieldByName('itensQuantidade').AsFloat;
...
begin
  ...
  try
    ...
    //Retorna ao Estoque
    RetornarEstoque(AVendaID, sCodNoCds, aeeApagar);
